...
using std::string, std::endl, std::cout, std::fixed, std::vector, std::shared_ptr,
        std::istringstream, std::cin, std::make_shared, std::runtime_error;
...
shared_ptr<Figure> CreateFigure(istringstream &args) {
    ...
    throw runtime_error("Wrong figure name");
}
